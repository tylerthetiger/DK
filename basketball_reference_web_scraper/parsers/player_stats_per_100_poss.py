...
def parse_player_100_poss(row):
    return {
        ...
        "made_free_throws": int(row[17].text_content()),
        "attempted_free_throws": int(row[18].text_content()),
        "offensive_rebounds": int(row[20].text_content()),
        "defensive_rebounds": int(row[21].text_content()),
        "assists": int(row[23].text_content()),
        "steals": int(row[24].text_content()),
        "blocks": int(row[25].text_content()),
        "turnovers": int(row[26].text_content()),
        "personal_fouls": int(row[27].text_content()),
        "offensive_rating":int(row[29].text_content()),
