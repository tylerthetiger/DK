...
from basketball_reference_web_scraper.parsers.team_misc_stats_parser import parse_teams_misc_stats
...
def team_misc_stats(season_end_year):
    ...
    return parse_teams_misc_stats(response.content)
